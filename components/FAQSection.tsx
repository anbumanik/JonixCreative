...
const FAQSection = () => {
  ...
  return (
    <section id="faq" className="bg-[#050508] relative overflow-hidden" style={{ paddingTop: '4rem', paddingBottom: '4rem', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
      ...
      <div className="w-full flex flex-col items-center overflow-hidden">
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-5xl md:text-6xl text-white mt-4">
              ...
              >
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between gap-3 px-5 sm:px-6 py-5 text-left cursor-pointer group"
                    style={{ paddingLeft: '1.5rem' }}
                  >
                    <span
                      className={`font-semibold text-sm sm:text-base leading-snug transition-colors duration-200 break-words ${
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <p className="px-5 sm:px-6 pb-5 text-slate-400 text-sm leading-relaxed border-t border-white/5 pt-4" style={{ paddingLeft: '1.5rem' }}>
                          {item.answer}
                        </p>
                      </motion.div>
                    )}

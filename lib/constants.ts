...
export const FALLBACK_PORTFOLIO: PortfolioProject[] = [
  {
    ...
    description: 'A dynamic montage with fast cuts, modern transitions, and electric color grading.',
  ...
  },
  {
    ...
    description: 'Dynamic and fast-paced short-form video editing.',
  ...
  },
  {
    ...
    description: 'A captivating short-form video for social media.',
  ...
  },
  {
    ...
    description: 'An eye-catching short-form promotional video.',
  ...
  },
  {
    ...
    description: 'Elegant full-length showcase for Huntington Jewelry.',
  ...
  },
  {
    ...
    description: 'A long-form teaser video capturing the best cinematic moments.',
  ...
  },
  {
    ...
    description: 'Captivating long-form highlights with smooth transitions.',
